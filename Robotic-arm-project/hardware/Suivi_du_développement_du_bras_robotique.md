...
Vous pourrez aussi trouvez la démonstration des formules des coordonnées de l'objet [ici](../hardware/Robotic-arm-project/hardware/Démonstration_des_formules_de_coordonnées.pdf)
